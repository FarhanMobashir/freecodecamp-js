    ...
    while (change != 0) {
        ...
        if (change >= 10 && cid[6][1] != 0) {
            if (Math.floor(change / 10) * 10 > cid[6][1]) {
                ...
                cid[6][1] = 0;
                result.status = "OPEN";
                console.log('if ten :' + change);

            } else {
                console.log('Ten :' + change)
        ...
        if (change >= 5 && cid[5][1] != 0) {
            if (Math.floor(change / 5) * 5 > cid[5][1]) {
                ...
                cid[5][1] = 0;
                result.status = "OPEN";
                console.log('if five :' + change);

            } else {
                console.log('else five :' + change)
